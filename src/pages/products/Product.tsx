...
const Product = (productsItems) => {
  ...
  if (selectedProduct) {
    ...
    return (
      <>
        <section className="items-center justify-center text-center text-2xl font-bold mt-10 grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
