...
const Store = () => {
  ...
  const handlePriceFilter = (e, sectionID) => {
    const searchParams = new URLSearchParams(location.search);
                ...
                >
                  <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                    ...
                    <form className="mt-4 border-t border-gray-200">
                      ...
                      <ul
                        role="list"
                        className="px-2 py-3 font-medium text-center text-gray-900"
                      >
                        Sub-Categories
                      </ul>
                                ...
                                <div className="space-y-6">
                                  {section.options.map((option, optionIdx) => (
                                    ...
                                    >
                                      <input
                                        onChange={(e) =>
                                          handlePriceFilter(e, section.id)
                                        }
                                        id={`filter-mobile-${section.id}-${optionIdx}`}
                                        name={`${section.id}[]`}
                                        defaultValue={option.value}
            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <form className="hidden lg:block">
                  ...
                  <ul
                    role="list"
                    className="space-y-4 border-b border-gray-200 pb-6 text-sm font-medium text-gray-500 flex justify-between"
                  >
                    Filters
